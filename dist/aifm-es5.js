...
(function(){var e=require("set-algebra"),t=1e15,r=9007199254740992,o=function(e){this._set=void 0!==e?new Set(e):new Set,this.size=0};o.prototype.add=function(e){return this._set.add(e),this.size=this._set.size,this},o.prototype.clear=function(){this._set.clear(),this.size=0},o.prototype.delete=function(e){var t=this._set.delete(e);return this.size=this._set.size,t},o.prototype.entries=function(){return this._set.entries()},o.prototype.forEach=function(e,t){this._set.forEach(e,t)},o.prototype.has=function(e){return this._set.has(e)},o.prototype.keys=function(){return this._set.keys()},o.prototype.values=function(){return this._set.values()},o.prototype["@@iterator"]=o.prototype.values,o.prototype.$verts=function(){for(var e,t=new o,r=this[Symbol.iterator]();!(e=r.next()).done;)for(var n,i=e.value,a=i.$verts(),s=a[Symbol.iterator]();!(n=s.next()).done;){var d=n.value;t.add(d)}return t},o.prototype.$edges=function(){for(var e,t=new o,r=this[Symbol.iterator]();!(e=r.next()).done;)for(var n,i=e.value,a=i.$$edges(),s=a[Symbol.iterator]();!(n=s.next()).done;){var d=n.value;t.add(d)}return t},o.prototype.$faces=function(){for(var e,t=new o,r=this[Symbol.iterator]();!(e=r.next()).done;)for(var n,i=e.value,a=i.$faces(),s=a[Symbol.iterator]();!(n=s.next()).done;){var d=n.value;t.add(d)}return t};var n=function(){this.id=void 0,this.annotation={},this.edges=new o};n.prototype.$verts=function(){for(var e,t=new o,r=this.edges[Symbol.iterator]();!(e=r.next()).done;){var n=e.value;t.add(n.vert1),t.add(n.vert2)}return t.delete(this),t},n.prototype.$edges=function(){return new o(this.edges)},n.prototype.$faces=function(){for(var e,t=new o,r=this.edges[Symbol.iterator]();!(e=r.next()).done;)for(var n,i=e.value,a=i.faces[Symbol.iterator]();!(n=a.next()).done;){var s=n.value;t.add(s)}return t};var i=function(){this.id=void 0,this.annotation={},this.vert1=void 0,this.vert2=void 0,this.faces=new o};i.prototype.$verts=function(){return new o([this.vert1,this.vert2])},i.prototype.$edges=function(){for(var e,t,r=new o,n=this.vert1.edges[Symbol.iterator]();!(t=n.next()).done;)e=t.value,r.add(e);for(var i,a=this.vert2.edges[Symbol.iterator]();!(i=a.next()).done;)e=i.value,r.add(e);return r.delete(this),r},i.prototype.$faces=function(){return new o(this.faces)};var a=function(){this.id=void 0,this.annotation={},this.edges=new o};a.prototype.$verts=function(){for(var e,t=new o,r=this.edges[Symbol.iterator]();!(e=r.next()).done;){var n=e.value;t.add(n.vert1),t.add(n.vert2)}return t},a.prototype.$edges=function(){return new o(this.edges)},a.prototype.$faces=function(){for(var e,t=new o,r=this.edges[Symbol.iterator]();!(e=r.next()).done;)for(var n,i=e.value,a=i.faces[Symbol.iterator]();!(n=a.next()).done;){var s=n.value;t.add(s)}return t.delete(this),t};var s=function(){this.verts=new Map,this.edges=new Map,this.faces=new Map};s.prototype.addVert=function(e){if(e instanceof n){var o=e.id?e.id:Math.floor(Math.random()*(r-t+1));return e.id=o,this.verts.set(o,e),e}throw new TypeError("Not a vert!")},s.prototype.addEdge=function(e){if(e instanceof i){var o=e.id?e.id:Math.floor(Math.random()*(r-t+1));return e.id=o,this.edges.set(o,e),e}throw new TypeError("Not an edge!")},s.prototype.addFace=function(e){if(e instanceof a){var o=e.id?e.id:Math.floor(Math.random()*(r-t+1));return e.id=o,this.faces.set(o,e),e}throw new TypeError("Not a face!")},s.prototype.deleteVert=function(e){return this.verts.delete(e instanceof n?e.id:e)},s.prototype.deleteEdge=function(e){return this.edges.delete(e instanceof i?e.id:e)},s.prototype.deleteFace=function(e){return this.faces.delete(e instanceof a?e.id:e)};var d=function(){s.call(this)};d.validateEdgeLoop=function(e){var t=$traceurRuntime.spread(e);if(t.length<3)return!1;var r,o,n=t[0].vert1,i=t[0].vert2,a=t[1].vert1,s=t[1].vert2;if(n===a)r=i,o=s;else if(n===s)r=i,o=a;else if(i===a)r=n,o=s;else{if(i!==s)return!1;r=n,o=a}for(var d=2;d<t.length;d++)if(a=t[d].vert1,s=t[d].vert2,o===a)o=s;else{if(o!==s)return!1;o=a}return o!==r?!1:!0},d.prototype=Object.create(d.prototype),d.prototype.addVertByCoords=function(e,t,r){var o=new n;return o.annotation.x=e?e:0,o.annotation.y=t?t:0,o.annotation.z=r?r:0,s.prototype.addVert.call(this,o)},d.prototype.addEdgeByVertPair=function(t,r,o){if((o||void 0===o)&&t===r)throw new TypeError("Degenerate edge!");if(!this.verts.has(t.id)||!this.verts.has(r.id))throw new ReferenceError("Vert not in mesh!");if((o||void 0===o)&&e.n(t.edges,r.edges).size)throw new ReferenceError("Vert pair already has edge in common!");var n=new i;return n.vert1=t,n.vert2=r,t.edges.add(n),r.edges.add(n),s.prototype.addEdge.call(this,n)},d.prototype.addFaceByEdgeLoop=function(e,t){if((t||void 0===t)&&!d.validateEdgeLoop(e))throw new TypeError("Degenerate edge-loop!");for(var r,o=new a,n=e[Symbol.iterator]();!(r=n.next()).done;){var i=r.value;if(!this.edges.has(i.id))throw new ReferenceError("Edge not in mesh!");i.faces.add(o),o.edges.add(i)}return s.prototype.addFace.call(this,o)},d.prototype.addFaceByVertLoop=function(t){if(t.length<3||t.size<3)throw new TypeError("Degenerate vert-loop!");for(var r,o,n=$traceurRuntime.spread(t),i=[],a=n[0],s=1;s<n.length;s++){if(r=n[s],o=e.n(a.edges,r.edges),o.size<1)throw new TypeError("Degenerate vert-loop!");i.push($traceurRuntime.spread(o)[0]),a=r}if(o=e.n(n[n.length-1].edges,n[0].edges),o.size<1)throw new TypeError("Degenerate vert-loop!");return i.push($traceurRuntime.spread(o)[0]),this.addFaceByEdgeLoop(i,!1)},module.exports={ElementSet:o,Vert:n,Edge:i,Face:a,Mesh:s,SimpleMesh:d}}).call(this);
},{"set-algebra":3}],2:[function(require,module,exports){
...
},{"./setalg-es5.js":4,"./setalg-es6.js":5,"traceur-runtime":6}],4:[function(require,module,exports){
(function() {
